...
class Skim_LlamaModel(LlamaPreTrainedModel):
    """
    ...
    def __init__(self, config: LlamaConfig):
        ...
        from modeling_skim_predictor import SkimPredictor, C2FPromptPruner_Embedding
        self.pruner = C2FPromptPruner_Embedding()
    ...
    def forward(
        ...
        hidden_states = self.pruner(inputs_embeds)
...
class Skim_LlamaForCausalLM(LlamaPreTrainedModel):
    _tied_weights_keys = ["lm_head.weight"]

    def __init__(self, config):
        super().__init__(config)
        self.model = Skim_LlamaModel(config)
